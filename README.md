...
- «Выйти» удаляет сессию аккаунта, «Удалить» — сам аккаунт вместе с профилем.

В каждый аккаунт человек входит сам в окне Chrome, включая 2FA. Приложение не хранит логины и пароли: только профили Chrome с их Cookie.
